...
Data mode: **live**. Depends on: Milestone 10.

Written ahead of Milestones 7–10 landing; re-review at plan gate.
...
- The address is config key #2: TOML `[serve] addr`, env `GSD_SERVE_ADDR`,
  ...
  config-report generalization recorded in `MILESTONE_8.md` (source
