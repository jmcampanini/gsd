...
- Entity row types (the bare table-row structs) live in `internal/domain`; entity packages re-export them with type aliases. Requests, projections, envelopes, and services stay in the entity package.
